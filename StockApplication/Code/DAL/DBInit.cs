        ...
        public static void Initialize(IApplicationBuilder app)
        {
            using(var serviceScope = app.ApplicationServices.CreateScope())
            {
                ...
                if (created)
                {
                    ...
                    string[] names = { "Random Inc.", "Organic Chemistry Inc.", "Starbux Inc.", "Techhex Inc.", "Tweeter", "JSon", "MeatA", "Betatech", "Mathworkz", "Metaverse", "Harrison Trumpets", "Out of Ideas Inc.", "Wowverse", "Nightfall", "Warhorse", "OJ", "Sweatshop Inc.", "Hans' Handlers" };
